...
4비트로 압축될 것을 전제로 학습한 QAT 버전이 있길래 시험해봤습니다. 학습을 끝낸 뒤에 압축하는 일반적인 방식과 달리 압축을 학습 과정에 미리 반영하는 방식이라, 같은 4비트여도 품질 손실이 적다고 합니다 (출처: [Google — Gemma 4 QAT 모델 발표](https://blog.google/innovation-and-ai/technology/developers-tools/quantization-aware-training-gemma-4/)). 실제로 같은 4비트인데 파일이 0.4GB 작았어요(7.2GB 대 7.6GB). 그런데 네 줄 시험지를 돌렸더니 전부 존댓말로 밀어버렸습니다. "안녕하세요", "바보 아니에요?" 같은 식으로요.
